...
role_1 = "You are ChatGPT, a large language model trained by OpenAI. Answer as concisely as possible. Knowledge cutoff: "+str(datetime.datetime.now())[0:10]+" Current date: "+str(datetime.datetime.now())[0:10]
